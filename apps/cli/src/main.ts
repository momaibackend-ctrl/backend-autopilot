...
const {service,bootstrap}=createRuntime();const cli=new Command().name('autopilot').description('Backend Autopilot v0.5 diagnostic and sandbox bootstrap CLI').version('0.5.0');
