...
const fallback:Screen[]=["dashboard","projects","delivery","tasks","runs","validation","api-explorer","database","infrastructure","artifacts","audit","capabilities","settings"].map((screenId,index)=>({screenId,navigationLabel:title(screenId),enabled:true,navigationOrder:(index+1)*10}));
