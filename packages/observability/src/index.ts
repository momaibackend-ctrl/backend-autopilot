...
export const logger=pino({level:process.env['AUTOPILOT_LOG_LEVEL']??'info',base:{service:'backend-autopilot',platformVersion:'0.5.0'},redact:{paths:['*.token','*.secret','*.password','*.authorization','*.apiKey'],censor:'[REDACTED]'}});
