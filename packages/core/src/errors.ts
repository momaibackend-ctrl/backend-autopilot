export type ErrorCode = 'POLICY_VIOLATION'|'UNKNOWN_RESOURCE'|'DEPENDENCY_BLOCKED'|'ARCHITECTURE_VIOLATION'|'EXECUTION_FAILED'|'TEST_FAILED'|'REVIEW_FAILED'|'CREDENTIAL_MISSING'|'NOT_SUPPORTED'|'NOT_FOUND'|'INVALID_STATE'|'CONFLICT';
